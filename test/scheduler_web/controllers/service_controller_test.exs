defmodule SchedulerWeb.ServiceControllerTest do
  use SchedulerWeb.ConnCase

  import Scheduler.ServicesFixtures

  @create_attrs %{active: true, description: "some description", service_name: "some service_name", price: "120.5"}
  ...
  describe "update service" do
    ...
    test "redirects when data is valid", %{conn: conn, service: service} do
      ...
      assert html_response(conn, 200) =~ "some updated service_name"
    end
